style_list = [
    ...
    },
    {
        ...
        "prompt": "{prompt} (Extremely Detailed Oil Painting:1.2), glow effects, godrays, Hand drawn, render, 8k, octane render, cinema 4d, blender,atmospheric 4k ultra detailed, cinematic sensual, Sharp focus, humorous illustration",
