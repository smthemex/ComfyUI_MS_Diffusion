...
The default repo_id models are tabilityai/stable-diffusion-xl-base-1.0 (for example,you can using :G161222/RealVisXL_V4.0, s stablediffusionapi/sdxl-unstable-diffusers-y ，sd-community/sdxl-flash...)     
